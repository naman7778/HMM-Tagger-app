...
Original file is located at
    https://colab.research.google.com/drive/1LQntIq456gZ9YYmd_MYyBACAc1_sWgy0
...
tags_dataframe = pd.DataFrame(tag_grid, columns = list(Tags), index=list(Tags))
...
class MainApp(MDApp):
    def build(self):
        ...
        label = MDLabel(text="Tokenizer", halign="center", font_size="64", size_hint_y=None,padding_y="15", pos_hint={'center_x': 0.5, 'center_y': 0.9})
